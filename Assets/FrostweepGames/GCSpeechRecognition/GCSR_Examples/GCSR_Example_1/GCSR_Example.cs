...
namespace FrostweepGames.Plugins.GoogleCloud.SpeechRecognition.Examples
{
    public class GCSR_Example : MonoBehaviour
    {
        ...
        public Button _getOperationButton,
        ...
        public Toggle _voiceDetectionToggle,
        ...
        private void InsertRecognitionResponseInfo(RecognitionResponse recognitionResponse)
        {
            ...
            Translator.Do("en", "hi", _resultText.text, (translated_str) => { _resultText.text = translated_str; });
